 ...
 */
final class Version20200325114913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat DROP monitor, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat ADD monitor TINYINT(1) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE goal CHANGE percentage percentage SMALLINT DEFAULT NULL, CHANGE last last SMALLINT DEFAULT NULL');
